...
public class AccountControllerTests {
	...
	public void accountStatementTest() {
		when(accountService.getAccountStatement("token", 1L, null, null)).thenReturn(new ArrayList<Transaction>());
		assertEquals(0, accountController.getAccountStatement("token", 1L, null, null).size());
	}
