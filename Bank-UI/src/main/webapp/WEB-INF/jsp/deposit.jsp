...
<body>
  ...
  <main id="main">
    ...
    <section id="depositamount" class="depositamount">
      <div class="container">
        ...
        <div class="row" data-aos="fade-in">
          <div class="col-sm-12 d-flex align-items-stretch">
            <div class="deposit Amount">
				...
				<form:form action="/deposit" method="POST" modelAttribute="accountInfo" >
            ...
            <br>
                  ...
                  <button accesskey="d" type="submit"><u>D</u>eposit</button>
        		</form:form>
            </div>
