...
public class CustomerController {
	...
	public ResponseEntity<AccountCreationStatus> createCustomer(@RequestHeader("Authorization") String token, @RequestBody CustomerEntity customer) throws DateTimeException, BindException{
